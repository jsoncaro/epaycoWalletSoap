 ...
 */
final class Version20200607021443 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE payment (id INT AUTO_INCREMENT NOT NULL, wallet_id INT NOT NULL, token VARCHAR(255) NOT NULL, confirmed TINYINT(1) NOT NULL, value INT NOT NULL, INDEX IDX_6D28840D712520F3 (wallet_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
